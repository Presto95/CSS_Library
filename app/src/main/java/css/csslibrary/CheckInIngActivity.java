...
public class CheckInIngActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_check_in_ing);
        textView = (TextView) findViewById(R.id.text_checkining);
        ...
        listView=(ListView)findViewById(R.id.list_view_checkining);
    ...
    class CustomTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                String str;
                //URL url = new URL("http://192.168.0.6:8080/CSSLibrary/checkining.jsp");//보낼 jsp 주소를 ""안에 작성합니다.
                URL url = new URL("http://192.168.226.1:8080/CSSLibrary/checkining.jsp");//보낼 jsp 주소를 ""안에 작성합니다.
